...
colliderbias <- function(x, ratio, bxy, varx = 1, sigma2y = 1, sigma2c = 1) {
  # x is bxc
  byc <- x / ratio
  vary <- bxy^2 * varx + sigma2y
  varc <- x^2 * varx + byc^2 * vary + 2 * x * bxy * byc * varx + sigma2c
...
# ui ----
  ...
  fluidRow(column(12, plotlyOutput("plot1"))),
    fluidRow(
      ...
      column(2,
             numericInput("varx", "$\\beta_{xy}$", value = 0, step = 0.1, width = "100px")),
      column(2,
             numericInput("varx", "$\\text{Var}(X)$", value = 1, step = 0.1, width = "100px")),
      column(1,
             numericInput("sigma2x", "$\\sigma^2_{y}$", value = 1, step = 0.1, width = "100px")),
      column(1,
             numericInput("sigma2x", "$\\sigma^2_{c}$", value = 1, step = 0.1, width = "100px")),
      column(2,
             numericInput("xmin", "X-axis min", value = -0.2, step = 0.1, width = "100px")),
      column(2,
             numericInput("xmax", "X-axis max", value = 0.2, step = 0.1, width = "100px"))
...
Please email, <tom.palmer@lancaster.ac.uk>, with any questions or comments or see the GitHub repo.